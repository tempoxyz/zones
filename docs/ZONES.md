...
| `--sequencer.prover-attestation-policy` | (required with remote address) | JSON PCR0–2 allowlist and evidence-freshness policy for Nitro-attested TLS |
...
| `SEQUENCER_PROVER_ATTESTATION_POLICY` | With remote prover | JSON PCR0–2 allowlist and evidence-freshness policy path |
