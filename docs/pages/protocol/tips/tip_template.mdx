# TIP Title
This document defines a template for Tempo Improvement Proposals (TIPs) on Tempo.

Each TIP fully describes a change to the Tempo protocol. TIPs are assigned incremental numbers, starting with 1000.
...
- **Related Specs/TIPs**: \<links or IDs>  
- **Protocol Version**: \<Protocol version at which TIP is scheduled to be included/was included>
---
