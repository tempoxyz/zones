# "Place-only mode" for next quote token

This document specifies a new DEX function for creating trading pairs against a token's staged next quote token, to allow orders to be placed on it.

- **TIP ID**: TIP-1001
- **Authors/Owners**: Dan Robinson
- **Status**: Draft
- **Related Specs/TIPs**: [Stablecoin DEX](/protocol/exchange/spec), [TIP-20](/protocol/tip20/spec)
