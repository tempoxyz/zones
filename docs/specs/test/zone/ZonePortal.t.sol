...
contract ZonePortalTest is BaseTest {
    ...
    function test_deposit_updatesHashChain() public {
        ...
        bytes32 hash1 = portal.deposit(address(pathUSD), alice, depositAmount, bytes32("memo1"), address(0));
        vm.stopPrank();
    ...
    function test_deposit_multipleDepositsChain() public {
        ...
        bytes32 hash1 = portal.deposit(address(pathUSD), alice, amount1, bytes32("memo1"), address(0));
        vm.stopPrank();

        // Second deposit from bob
        vm.startPrank(bob);
        pathUSD.approve(address(portal), amount2);
        bytes32 hash2 = portal.deposit(address(pathUSD), bob, amount2, bytes32("memo2"), address(0));
        vm.stopPrank();
    ...
    function test_deposit_allowsCompoundPolicyMintRecipient() public {
        ...
        vm.startPrank(alice);
        pathUSD.approve(address(portal), depositAmount);
        bytes32 depositHash = portal.deposit(address(pathUSD), bob, depositAmount, bytes32("memo"), address(0));
        vm.stopPrank();
    ...
    function test_submitBatch_updatesState() public {
        ...
        pathUSD.approve(address(portal), depositAmount);
        bytes32 depositHash =
            portal.deposit(address(pathUSD), alice, depositAmount, bytes32("memo"), address(0));
        vm.stopPrank();
    ...
    function test_depositChain_singleSlotDesign() public {
        ...
        bytes32 h1 = portal.deposit(address(pathUSD), alice, 1000e6, bytes32("d1"), address(0));
        bytes32 h2 = portal.deposit(address(pathUSD), alice, 1000e6, bytes32("d2"), address(0));
        vm.stopPrank();
        ...
        // New deposit arrives
        vm.startPrank(alice);
        bytes32 h3 = portal.deposit(address(pathUSD), alice, 1000e6, bytes32("d3"), address(0));
        vm.stopPrank();
    ...
    function test_submitBatch_usesInternalProcessedHash() public {
        ...
        portal.deposit(address(pathUSD), alice, 1000e6, bytes32("memo"), address(0));
        vm.stopPrank();
    ...
    function test_withdrawalQueue_emptyBatchDoesNotIncreaseTail() public {
        vm.startPrank(alice);
        pathUSD.approve(address(portal), 1000e6);
        portal.deposit(address(pathUSD), alice, 1000e6, bytes32(""), address(0));
        vm.stopPrank();
    ...
    function test_processWithdrawal_mustProcessInOrder() public {
        ...
        portal.deposit(address(pathUSD), alice, 10_000e6, bytes32(""), address(0));
        vm.stopPrank();
    ...
    function test_deposit_emitsDepositMadeEvent() public {
        ...
        emit IZonePortal.DepositMade(
            expectedHash, alice, address(pathUSD), bob, netAmount, fee, bytes32("test"), address(0)
        );

        portal.deposit(address(pathUSD), bob, 500e6, bytes32("test"), address(0));
        vm.stopPrank();
    }
    ...
    function test_depositEncrypted_success() public {
        ...
        pathUSD.approve(address(portal), depositAmount);
        bytes32 hash =
            portal.depositEncrypted(address(pathUSD), depositAmount, 0, _makeEncryptedPayload(), address(0));
        vm.stopPrank();
    ...
    function test_depositEncrypted_hashChainMatchesLibrary() public {
        ...
        vm.startPrank(alice);
        pathUSD.approve(address(portal), depositAmount);
        bytes32 hash = portal.depositEncrypted(address(pathUSD), depositAmount, 0, encrypted, address(0));
        vm.stopPrank();
    ...
    function test_depositEncrypted_mixedQueue() public {
        ...
        vm.startPrank(alice);
        pathUSD.approve(address(portal), amount * 3);
        bytes32 h1 = portal.deposit(address(pathUSD), alice, amount, bytes32("memo"), address(0));

        // Encrypted deposit from alice
        bytes32 h2 = portal.depositEncrypted(address(pathUSD), amount, 0, _makeEncryptedPayload(), address(0));
        vm.stopPrank();
    ...
    function test_depositEncrypted_emitsEvent() public {
        ...
        portal.depositEncrypted(address(pathUSD), depositAmount, 0, encrypted, address(0));
        vm.stopPrank();
    }
    ...
    function test_depositEncrypted_revertsOnDepositTooSmall() public {
        ...
        portal.depositEncrypted(address(pathUSD), 100_000, 0, _makeEncryptedPayload(), address(0)); // amount == fee
        vm.stopPrank();
    }
    ...
    function test_depositEncrypted_revertsOnCiphertextTooShort() public {
        ...
        portal.depositEncrypted(address(pathUSD), 1000e6, 0, payload, address(0));
        vm.stopPrank();
    }
