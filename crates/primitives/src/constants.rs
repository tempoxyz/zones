...
/// Sentinel emitted as `BatchSubmitted.withdrawalQueueSlot` when a batch carried no
/// withdrawals and therefore consumed no queue slot (`NO_QUEUE_SLOT` in Solidity).
pub const NO_QUEUE_SLOT: U256 = U256::MAX;
