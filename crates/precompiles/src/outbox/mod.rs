...
impl ZoneOutbox {
    ...
    fn enforce_withdrawal_block_cap(&mut self) -> ZoneResult<()> {
        // NOTE: jtcn 117: Caps how many withdrawal requests one Zone block can create so it cannot
    ...
    fn request_withdrawal<P: L1StorageReader>(
        ...
        // NOTE: jtcn 124: Saves the chosen Zone fallback recipient behind a nonce. If L1 delivery
    ...
    pub(crate) fn enqueue_deposit_bounce_back(
        ...
        // NOTE: jtcn 119: Only the Inbox can turn a failed deposit into this zero fee withdrawal.
