...
pub use zone_primitives::constants::{
    ...
    PORTAL_ENFORCEMENT_MODES_SLOT, PORTAL_GATEWAY_MODE_SLOT, PORTAL_MAX_TEMPO_GAS_RATE_SLOT,
    PORTAL_ROLE_SLOT, PORTAL_TOKEN_CONFIGS_SLOT,
    TEMPO_STATE_ADDRESS, ZONE_FEE_MANAGER_ADDRESS, ZONE_INBOX_ADDRESS, ZONE_OUTBOX_ADDRESS,
