...
/// Complete Zone and Tempo state witness for replaying one Zone block.
#[derive(Clone, Debug, Default, PartialEq, Eq, Serialize, Deserialize)]
pub struct ZoneExecutionWitness {
    /// Number of the Zone block witnessed by this response.
    pub block_number: u64,
    /// Hash of the Zone block witnessed by this response.
    pub block_hash: B256,
    /// Parent Zone block whose state is witnessed.
