    ...
    vec![
        ...
        (
            ...
            TestAccount {
                nonce: 1,
                storage: vec![
                    (TEMPO_STATE_BLOCK_HASH_SLOT, U256::from(0xdead)),
                    (TEMPO_STATE_STATE_ROOT_SLOT, U256::from(0xcafe)),
                    (
        ...
        (
            ...
            TestAccount {
                nonce: 1,
                storage: vec![(ZONE_INBOX_PROCESSED_HASH_SLOT, U256::ZERO)],
                ..Default::default()
            },
        ),
        ...
        (
            ...
            TestAccount {
                nonce: 1,
                storage: vec![
                    (ZONE_OUTBOX_LAST_BATCH_BASE_SLOT, U256::ZERO),
                    (
