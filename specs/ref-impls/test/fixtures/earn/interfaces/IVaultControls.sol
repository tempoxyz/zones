...
/// @notice Deployment-fixed policy for the adapter's whole-pool engine migration seam.
...
struct ControlInit {
    ...
    /// @dev Fixed forever at adapter initialization; there is intentionally no setter.
